...
namespace WeddingPlannerApplication.Controllers
{
    ...
    public class PlannerUserController : Controller
    {
        private readonly UserManager<ApplicationUser> _userManager;

        public PlannerUserController(UserManager<ApplicationUser> userManager)
        {
        ...
        {
            var users = await _userManager.GetUsersInRoleAsync("Planner");
            return View(users);
        }
        ...
        public async Task<IActionResult> Create(ApplicationUser model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(newAdmin, "Planner");

...
using WeddingPlannerApplication.Data.Seeders;
...
else
{
    ...
    // The default HSTS value is 30 days. You may want to change this for production dfdfdfdf scenarios, see https://aka.ms/aspnetcore-hsts.
    app.UseHsts();
}

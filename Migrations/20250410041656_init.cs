        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SystemUsageLogs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlannerUserId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeddingPlanners_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CoupleMembers_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WeddingBudgets_Couples_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingChecklists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingChecklists_Couples_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeddingTimelines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeddingTimelines_Couples_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CoupleWeddingPlanner_Couples_AssignedCouplesId",
                        column: x => x.AssignedCouplesId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CoupleWeddingPlanner_WeddingPlanners_PlannersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AuditLogs_CoupleMembers_CoupleMemberId",
                        column: x => x.CoupleMemberId,
                        principalTable: "CoupleMembers",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateTable(
                name: "VendorAvailabilities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorAvailabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorAvailabilities_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Couples_CoupleId",
                        column: x => x.CoupleId,
                        principalTable: "Couples",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_CoupleMemberId",
                table: "AuditLogs",
                column: "CoupleMemberId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_CoupleId",
                table: "Bookings",
                column: "CoupleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CoupleMembers_ApplicationUserId",
                table: "CoupleMembers",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SystemUsageLogs_ApplicationUserId",
                table: "SystemUsageLogs",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorAvailabilities_VendorId",
                table: "VendorAvailabilities",
                column: "VendorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeddingBudgets_CoupleId",
                table: "WeddingBudgets",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingChecklists_CoupleId",
                table: "WeddingChecklists",
                column: "CoupleId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingPlanners_ApplicationUserId",
                table: "WeddingPlanners",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_WeddingTimelines_CoupleId",
                table: "WeddingTimelines",
                column: "CoupleId");
        }
